...
if(NOT "/home/gauss/Carla_096/AV_Planning/AV_Planning/src/AV_Parking_Planning/include " STREQUAL " ")
  set(AV_Parking_Planning_INCLUDE_DIRS "")
  set(_include_dirs "/home/gauss/Carla_096/AV_Planning/AV_Planning/src/AV_Parking_Planning/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'AV_Parking_Planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gauss/Carla_096/AV_Planning/AV_Planning/src/AV_Parking_Planning/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gauss/Carla_096/AV_Planning/AV_Planning/devel/lib;/home/gauss/Carla_096/AV_Planning/AV_Planning/devel/lib;/opt/ros/kinetic/lib)
